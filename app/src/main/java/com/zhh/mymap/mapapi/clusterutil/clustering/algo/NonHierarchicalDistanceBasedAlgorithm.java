...
import com.zhh.mymap.mapapi.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.zhh.mymap.mapapi.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.zhh.mymap.mapapi.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.zhh.mymap.mapapi.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.zhh.mymap.mapapi.clusterutil.clustering.algo
